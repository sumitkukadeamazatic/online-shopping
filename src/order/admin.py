...
class CartProductAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ['id', 'cart_id', 'product_seller', 'quantity', 'is_order_generated', 'created_at', 'updated_at']
...
class LineitemAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ['id', 'order_id', 'product_seller', 'status', 'quantity', 'base_price', 'shiping_cost', 'selling_price', 'gift_wrap_charges', 'created_at', 'updated_at']
