...
class ProductAdmin(admin.ModelAdmin):
    list_display = ['name','slug','description','base_price','selling_price','created_at','updated_at','images']
...
class TaxAdmin(admin.ModelAdmin):
    list_display = ['name','slug','percent','is_active','created_at','updated_at']
...
class ProductSellerAdmin(admin.ModelAdmin):
    list_display = ['quantity','discount','min_delivery_days','max_delivery_days','available_pin_codes','is_default','created_at','updated_at']
...
class ReviewAdmin(admin.ModelAdmin):
    list_display = ['user','seller','product','rating','title','description']
...
admin.site.register(models.CategoryTax, CategoryAdmin)
