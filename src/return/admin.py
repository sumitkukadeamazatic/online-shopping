...
class ReturnLineitemAdmin(admin.ModelAdmin):
    list_display = ['return_order_id','lineitem_id','quantity','reason','description','status','created_at','updated_at']
    list_filter = ['return_order_id','status','reason','created_at','updated_at']
...
class ReturnOrderLogAdmin(admin.ModelAdmin):
    list_display = ['return_lineitem_id','status','description','created_at','updated_at']
...
class ReturnLineitemShippingDetailAdmin(admin.ModelAdmin):
    list_display = ['shipping_detail_id','return_lineitem_id','quantity','description','created_at','updated_at']
    list_filter = ['shipping_detail_id','return_lineitem_id','quantity','created_at','updated_at']
    list_editable = ['quantity']

admin.site.register(models.ReturnLineitemShippingDetail, ReturnLineitemShippingDetailAdmin)
